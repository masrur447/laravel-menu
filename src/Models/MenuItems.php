...
namespace Bdacademy\LaravelMenu\Models;
...
class MenuItems extends Model
{
    ...
    {
        return $this->belongsTo('Bdacademy\LaravelMenu\Models\Menus', 'menu');
    }

    public function child()
    {
        return $this->hasMany('Bdacademy\LaravelMenu\Models\MenuItems', 'parent')->orderBy('sort', 'ASC');
    }
}
